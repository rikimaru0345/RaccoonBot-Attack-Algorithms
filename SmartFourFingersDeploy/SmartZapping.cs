...
namespace SmartFourFingersDeploy
{
    class SmartZapping
    {
        ...
        public static IEnumerable<int> SmartZap(int deAmount, int drillLevel, List<DeployElement> spells, int useEqOnDrills)
        {
            ...
            // Use EQ on Drills
            if (useEqOnDrills == 1)
                foreach (var t in UseEQOnDrills(drillLevel, spells))
                    yield return t;
