...
namespace AllInOnePushDeploy
{
    ...
    public class AllInOnePushDeploy : BaseAttack
    {
        ...
        internal static AlgorithmSettings DefineSettings()
        {
            ...
            deploy1.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
            ...
            deploy2.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
            ...
            deploy3.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
            ...
            deploy4.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
            ...
            deploy5.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
            ...
            deploy6.PossibleValues.Add(new SettingOption("Air Funnlling", 11));
